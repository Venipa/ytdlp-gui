...
const getSectionContentByTitle = (title: string) =>
  Object.values(SECTIONTABS).find((d) => d.meta.title === title)?.default
export default function SettingsDialog({
  ...
  return (
    ...
    >
      ...
      <SheetContent
        side="bottom"
        className="flex flex-col overflow-y-auto mx-auto max-w-5xl xl:max-w-6xl 2xl:max-w-7xl h-[90vh] rounded-t-lg border border-t-muted pb-0"
      >
          ...
          <div className="grid grid-cols-[148px_1fr] h-full flex-auto -mt-6">
            ...
            >
              ...
              <div className="flex flex-col text-xs text-muted-foreground px-2 items-end">
                ...
                <ClickableText
                  onClick={() =>
                    navigator.clipboard.writeText(buildInfo).then(() => toast('Copied build id'))
                  }
                >
                  {buildInfo}
                </ClickableText>
