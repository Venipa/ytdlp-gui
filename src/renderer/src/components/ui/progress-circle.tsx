...
export function ProgressCircle({ max = 100, min = 0, value = 0, showValue = true, gaugePrimaryColor, gaugeSecondaryColor, className }: AnimatedCircularProgressBarProps) {
		...
		<div
			...
			<svg fill='none' className='size-full' strokeWidth='2' viewBox='0 0 100 100'>
				...
				<circle
					...
					strokeLinecap='round'
					strokeLinejoin='round'
					className='opacity-100 stroke-muted-foreground'
					style={
						{
