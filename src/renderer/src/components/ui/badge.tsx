	...
	"inline-flex items-center rounded-md border font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 select-none cursor-default",
	{
		variants: {
			variant: {
				...
				destructive: "border-destructive bg-destructive/20 text-destructive-foreground shadow hover:bg-destructive/30",
				outline: "text-foreground",
				pre: "text-muted-foreground bg-muted/20 border-muted/40 font-mono",
			},
			size: {
