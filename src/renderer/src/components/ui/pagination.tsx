...
type PaginationItemProps = { active: boolean; disabled: boolean };
const PaginationItem = React.forwardRef<HTMLLIElement, React.ComponentProps<"li"> & Partial<PaginationItemProps>>(({ className, active, disabled, ...props }, ref) => <li ref={ref} className={cn("select-none", className, active && "active", (disabled && "disabled cursor-default") || "cursor-pointer")} {...props} />);
...
const PaginationPrevious = ({ className, disabled, ...props }: React.ComponentProps<typeof PaginationLink> & { disabled?: boolean }) => (
  <PaginationLink aria-label="Go to previous page" aria-disabled={disabled} size="default" className={cn("gap-1 pl-2.5", className)} {...props}>
...
const PaginationNext = ({ className, disabled, ...props }: React.ComponentProps<typeof PaginationLink> & { disabled?: boolean }) => (
  <PaginationLink aria-label="Go to next page" aria-disabled={disabled} size="default" className={cn("gap-1 pr-2.5", className)} {...props}>
    <span>Next</span>
