	...
	const form = useForm({
		defaultValues: {
			flags: {
				...
				videoTypes: settings?.flags?.videoTypes || [],
			},
		},
	});
				...
				<Form {...form}>
					<form className='flex flex-col gap-4 lg:gap-6 lg:grid lg:grid-cols-2 lg:items-start lg:justify-start'>
						<div className='space-y-4 flex flex-col'>
							<h3 className='text-sm font-medium'>YouTube Options</h3>
							<SelectOption
							...
							/>
							<ToggleOption control={form.control} name='flags.noLiveChat' label='No Live Chat' description='Prevent downloading of live chat/danmaku as subtitles' />
							<ToggleOption
								control={form.control}
						...
						<div className='space-y-4 flex flex-col'>
							<h3 className='text-sm font-medium'>Streaming Options</h3>
							<SelectOption
								control={form.control}
						...
						<div className='space-y-4 flex flex-col'>
							<h3 className='text-sm font-medium'>Download and Merge Options</h3>
							<ToggleOption control={form.control} name='flags.noDirectMerge' label='No Direct Merge' description='Prevent direct merging of video and audio files' />
							<ToggleOption
								control={form.control}
						...
						<div className='space-y-4 flex flex-col'>
							<h3 className='text-sm font-medium'>Metadata Options</h3>
						...
						<div className='space-y-4 flex flex-col'>
							...
							<ToggleOption control={form.control} name='flags.filenameSanitization' label='Filename Sanitization' description='Enable sanitization of filenames' />
