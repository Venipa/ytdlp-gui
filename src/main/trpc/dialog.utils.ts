...
export const loadUrlOfWindow = (win: BrowserWindow, page?: string, options: LoadFileOptions = {}) => {
...
export function lockCenterWithParent(win: BrowserWindow) {
	...
	if (!win.isModal() || !(parentWindow = win.getParentWindow()!) || parentWindow.isDestroyed() || !parentWindow.isMovable()) return;
